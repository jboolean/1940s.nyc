...
export function buildLlmSystemPrompt(): string {
  ...
  return [
    'You are reading user-submitted stories about places in New York City.',
    'You will be given the submission as a JSON object. For each statement below, output the probability (0 to 1) that the statement is true of this submission.',
    'A probability near 1 means the statement is clearly true of it. A probability near 0 means it is clearly false.',
    '',
    'Statements:',
    ruleList,
    '',
